...
> critical routing has started, but 145 connection items remain open. RF/LF
...
| Routed checkpoint | 1857 track segments / 337 vias / 23 zones |
| Remaining connection items | 145 |
