...
> critical routing has started, but 142 connection items remain open. RF/LF
...
| Routed checkpoint | 1881 track segments / 342 vias / 23 zones |
| Remaining connection items | 142 |
