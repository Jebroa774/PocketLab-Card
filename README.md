...
> critical routing has started, but 146 connection items remain open. RF/LF
...
| Routed checkpoint | 1854 track segments / 336 vias / 23 zones |
| Remaining connection items | 146 |
