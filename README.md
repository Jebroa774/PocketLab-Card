...
> connection items. It still has 1,154 DRC findings in the saved median run,
...
| Routed checkpoint | 2842 track segments / 575 vias / 23 zones |
| Remaining connection items | 0 |
| DRC findings (median of three runs) | 1154 |
