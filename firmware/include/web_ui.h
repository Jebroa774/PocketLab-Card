...
<body>
  ...
  <main>
    ...
    <section class="card"><h2>Hardware</h2><div class="row"><span>microSD</span><span id="sd">–</span></div><div class="row"><span>NFC</span><span id="nfc">–</span></div><div class="row"><span>Sub-GHz</span><span id="subghz">–</span></div><div class="row"><span>I/O-Expander</span><span id="ioexp">–</span></div><div class="safe">TX und freie GPIO-Ausgänge sind in diesem Build gesperrt.</div></section>
