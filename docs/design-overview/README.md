...
fabrication appearance. Placement is complete, but 145 connection items remain
...
copper item, footprint-library checks and one copper-sliver warning. The 145 unconnected
