...
fabrication appearance. Placement is complete, but 146 connection items remain
...
copper item, footprint-library checks and one copper-sliver warning. The 146 unconnected
