...
fabrication appearance. Placement is complete, but 139 connection items remain
...
copper item, footprint-library checks and one copper-sliver warning. The 139 unconnected
