...
fabrication appearance. Placement is complete, but 140 connection items remain
...
copper item, footprint-library checks and one copper-sliver warning. The 140 unconnected
