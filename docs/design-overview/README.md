...
fabrication appearance. Placement is complete, but 144 connection items remain
...
copper item, footprint-library checks and one copper-sliver warning. The 144 unconnected
